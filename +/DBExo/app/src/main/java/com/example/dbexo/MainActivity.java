...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView ls = findViewById(R.id.liste);
    ...
    public void Enregistrer(View view) {
        TextView nom = findViewById(R.id.EditText_Name);
    ...
    public void Update(View view) {
        TextView chNom = findViewById(R.id.EditText_Name);
        EditText chID = findViewById(R.id.editText_ID);
        ListView ls = (ListView) findViewById(R.id.liste);
        DBconnection db = new DBconnection(this);
    ...
    public void Supprimer(View view) {
        TextView chId = findViewById(R.id.editText_ID);
        ListView ls = (ListView) findViewById(R.id.liste);
        DBconnection db = new DBconnection(this);
