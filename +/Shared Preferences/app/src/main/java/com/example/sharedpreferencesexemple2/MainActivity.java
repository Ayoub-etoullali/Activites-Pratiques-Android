...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton radioButtonEasy = (RadioButton) this.findViewById(R.id.radioButton_easy);

        RadioButton radioButtonMedium = (RadioButton) this.findViewById(R.id.radioButton_medium);
        RadioButton radioButtonHard = (RadioButton) this.findViewById(R.id.radioButton_hard);
